                                    ...
                                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input name="address" id="cc_number" type="text" data-error=".errorTxt2" required>
                                                <label for="cc_number" class="">Enter your address</label>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div>
                            <div class="card-panel">
                                <div class="row">
                                    <form id="myForm" action="map.php" method="post">
                                        <h4>Or choose your location on google map</h4>
                                        <button class="btn cyan waves-effect waves-light" type="submit" id="sub" name="action">open map
                                        </button>

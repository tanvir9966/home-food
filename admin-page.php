    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="admin-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
...
<table>
				...
				<?php
                    ...
                    echo '<input id="image" name="image" type="file" data-error=".errorTxt03"><div class="errorTxt03"></div></td>';
					echo '<td></tr>';
				?>
                    </tbody>
</table>

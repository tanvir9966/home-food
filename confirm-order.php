        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/demo-logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="cus-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
            </li>
                <li class="no-padding">
...
<ul id="issues-collection" class="collection">
    ...
    <li class="collection-item avatar">
        ...
        <?php
         ...
         elseif ($_POST['one'] == null or $_POST['two'] == null)
         {
             ?>

             <script>
                 alert("Location not found. Please write your address manually.");
                 location.replace("cus-page.php");
             </script>
         ...
         else
         {
             ...
             <p><strong>Address:</strong> <a style="color: #0089c7; text-decoration: underline; -webkit-text-decoration-color: #a2dffb; text-decoration-color: #a2dffb;" href="https://www.google.com/maps/search/?api=1&query=<?php echo $_POST['one'] . "," . $_POST['two']; ?>" target="_blank">View on map</a> </p>

             <?php
         }

        ?>
        <p><strong>Payment Type:</strong> <?php echo $_POST['payment_type']; ?> </p>
...
<input type="hidden" name="payment_type" value="<?php echo $_POST['payment_type'];?>">
    ...
    else
    {
        ...
        <input type="hidden" name="lat" value="<?php echo htmlspecialchars($_POST['one']);?>">
        <input type="hidden" name="long" value="<?php echo htmlspecialchars($_POST['two']);?>">
...
<?php
	...
	else
	{
        ...
        elseif ($_SESSION['del_man_sid'] == session_id())
        {
